...
{
	private TileEntityBasicGenerator tileFurnace;
	private int lastCookTime;
	private int lastBurnTime;
	private int lastItemBurnTime;

	public ContainerBasicGenerator(InventoryPlayer player, TileEntityBasicGenerator tileEntityFurnace){
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				}else if(TileEntityBasicGenerator.isItemFuel(itemstack1)){
